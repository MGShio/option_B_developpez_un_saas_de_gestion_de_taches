...
// ============================================
// ROLE: Conteneur pour le composant Register avec protection de redirection
...
//   - Rend le composant Register si non authentifie
//
// DEPENDANCES:
...
// - @/pages/auth/Register: composant principal d'inscription
...
// ============================================
// 5. COMPOSANT DE PAGE (REGISTERRPAGE)
// ============================================
// @action:
...
//   4. Rend le composant Register si non authentifie
//
// @returns: JSX.Element - Le composant Register ou l'ecran de chargement
...
export default function RegisterPage() {
  ...
  // 5.3. RENDU PRINCIPAL
  // ============================================
  // @action: Rend le composant Register
